				...
				clients.forEach((socketListId) => {
					...
					connections[socketListId].onaddstream = (event) => {
						...
						if (searchVidep !== null) { // if i don't do this check it make an empyt square
							...
							borderStyle: "solid",borderWidth:"thin",borderColor: "#bdbdbd", objectFit: "fill"}
					...
					<div>
						<div style={{background: "white", width: "30%", height: "auto", padding: "20px", minWidth: "400px",
							...
							<Badge color="secondary" >
									<IconButton style={{ color: "#424242" }} onClick={this.connect}>
										<SendOutlined />
									</IconButton>
							</Badge>
						</div>
						...
						<div style={{ justifyContent: "center", textAlign: "center", paddingTop: "40px" }}>
							<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
								borderStyle: "solid",borderWidth:"thin",borderColor: "#bdbdbd",objectFit: "fill",width: "60%",height: "30%"}}></video>
						</div>
					</div>
					:
					<div>
						<div className="btn-down" style={{ textAlign: "center"}}>
							...
							<Badge color="secondary" >
								<IconButton style={{ color: "#424242" }} onClick={this.copyUrl}>
									<ShareOutlined />
								</IconButton>
							</Badge>	
						</div>
						...
						<div className="container">
							<Row id="main" className="flex-container" style={{ margin: 0, padding: 0 }}>
								<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
									borderStyle: "solid",borderColor: "#bdbdbd",borderWidth:'thin',margin: "10px",objectFit: "fill",
